...
soal_pertama_pangkat =random.randint(1,100)                           
soal_kedua_pangkat =random.randint(1,100)

jawabanya_adalah =float(soal_pertama + soal_kedua)
jawabanya_adalah_dua = soal_pertama - soal_kedua                      
jawabanya_adalah_tiga = soal_pertama * soal_kedua
...
if opsi =="2":
   ...
   *** Gem Tebak-Tebakan***
   ************************''')
   gem =input(f''' |__| |__| |__| |__| TEMUKAN DI MANA KH SAYA BERADA (1/2/3/4):''')                                                       
   if gem ==posisi_saya:
...
if opsi_pertanyaan =="1":                                                
   print(f''' {soal_pertama} + {soal_kedua} = ?''' )
